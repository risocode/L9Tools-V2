            ...
            <AccordionContent>
              <div className="p-4 space-y-4 bg-black/20">
                ...
                <div className="flex justify-around items-center pt-2">
                    ...
                    <Button variant="ghost" size="icon" title="Set Time of Death" onClick={() => onOpenTimeDialog(boss)} disabled={boss.isFixedSpawn} className="icon-glow-purple-on-hover relative">
