  ...
  return (
    <div className={cn("p-2 space-y-2", className)}>
        <Accordion type="multiple" className="w-full space-y-2">
            {avatars.map((avatar) => (
            <AccordionItem key={avatar.id} value={`item-${avatar.id}`} className="border-b-white/5 bg-black/20 rounded-lg">
                ...
                <div className="bg-black/30 p-4 rounded-md border border-primary/10">
                    <h3 className="font-cinzel text-base font-semibold text-golden mb-3">Base Stats</h3>
                     ...
                     <div className="flex justify-between items-center">
                        <div>
                         ...
                         {avatar.fatedRelationship.name !== 'N/A' && (
                            <div 
                                className="flex items-center space-x-2 p-2 rounded-lg bg-primary/5 hover:bg-primary/10 transition-colors"
                            ...
                            >
                                ...
                                />
                                <Label htmlFor={`fated-mobile-${avatar.id}`} className="font-semibold text-primary text-xs cursor-pointer">
                                    Fated
                                </Label>
                            </div>
                        )}
