  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
                        ...
                        {activeTab === 'gcash' && (
                            <div className="flex flex-col items-center gap-4 text-center w-full">
                                ...
                                <button
                                    ...
                                    className="gaming-enlarge-button"
                                >
                                    Enlarge
                                </button>
                            </div>
      ...
      <Dialog open={isQREnlarged} onOpenChange={setIsQREnlarged}>
        <DialogContent className="sm:max-w-md bg-white border-0 shadow-lg p-0">
          <div className="relative bg-white p-6 flex flex-col items-center gap-4">
            <DialogClose asChild>
              <Button
                size="icon"
                variant="ghost"
            ...
            <DialogHeader className="text-center">
              <DialogTitle className="text-2xl font-cinzel font-bold text-gray-900">
                GCash QR Code
              </DialogTitle>
            </DialogHeader>
            <div className="bg-white p-4 rounded-lg">
              <Image 
                src="/wallet/gcashqr.jpg" 
                alt="GCash QR Code" 
                width={400} 
                height={400} 
