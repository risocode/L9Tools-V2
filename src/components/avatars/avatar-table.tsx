        ...
        <Accordion type="single" collapsible className="w-full space-y-2" value={expandedValue} onValueChange={handleValueChange}>
            {avatars.map((avatar) => {
              ...
              <AccordionItem 
                key={avatar.id} 
                value={itemValue} 
                className="bg-black/20 rounded-lg border-primary/10"
              >
                  <AccordionTrigger 
                  ...
                  <div className="bg-black/30 p-4 rounded-md border border-primary/10">
                      <h3 className="font-cinzel text-lg font-semibold text-golden mb-3">
                            ...
                            <div>
                             ...
                             {avatar.fatedRelationship.name !== 'N/A' && (
                                ...
                                >
                                    ...
                                    />
                                    <Label htmlFor={`fated-${avatar.id}`} className={cn(
